...
const foodapi = `https://apis.data.go.kr/B551011/KorService1/areaBasedList1?serviceKey=${serviceKey}&numOfRows=112&pageNo=1&MobileOS=ETC&MobileApp=AppTest&_type=json&listYN=Y&arrange=o&contentTypeId=39&areaCode=7`;
const getfood = () => {
    fetch(foodapi).then((response) => response.json()).then((data) => {
